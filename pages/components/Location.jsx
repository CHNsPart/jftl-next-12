...
const Location = () => {
  return (
    ...
    <div id='location' className='bg-[#020721] dark:bg-transparent h-fit w-full py-10 flex flex-row justify-center items-center'>
        ...
        <div className='bg-[#020721] dark:bg-transparent h-fit w-full px-10 flex flex-row justify-center items-center'>
        <video
            autoPlay
            loop
            muted
        ...
        >
            <source src="https://jftl-bd.com/droneRear.mp4" type='video/mp4' />
